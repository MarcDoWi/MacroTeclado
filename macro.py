...
#Próximo:
    ...
    #3. 💡 Me gustaría que el ValueError mostrara un mensaje diferente si el error es porque el número no es positivo o si es porque se ha insertado algo que no es un número.
